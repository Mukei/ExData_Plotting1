...
# Top right figure
with(dt, plot(datetime, Voltage, type = "l", ylab = "Voltage"))
...
legend("topright", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lwd = par("lwd"), bty = "n")
